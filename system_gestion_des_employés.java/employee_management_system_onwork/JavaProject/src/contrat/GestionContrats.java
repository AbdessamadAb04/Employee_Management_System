...
import employe.CadreIntermediaire;
import employe.CadreSuperieur;
import employe.Dirigeant;
import employe.Employe;
import employe.FonctionSupport;
import employe.Operationel;
import gestionSysteme.Validateur;




public class GestionContrats implements Validateur {
    ...
    private void instancierContrat(Contrat contrat, int id) {
    ...
    private String saisieTypeContrat(Contrat contrat, String typeSaisie) throws InterruptedException {

        boolean typeContratInput;
        String typeContrat;

        if(typeSaisie.equals("modification")) {
            System.out.println("Ancien type contrat: " + contrat.getTypeContrat() + "\n");
            Thread.sleep(200);
        }
        ...
        do {
            ...
            typeContrat = scanner.nextLine();
            Thread.sleep(200);

            typeContratInput = validateurTypeContrat(typeContrat);

        } while(typeContratInput != true);

        if(typeSaisie.equals("lecture")) {
            return typeContrat;
        } else {
            contrat.setTypeContrat(typeContrat);
            System.out.println("Saisie complété avec succès");
            return typeContrat;
        }
    ...
    private String saisief(Contrat Contrat, String typeSaisie) throws InterruptedException {

        boolean fInput;
        String prenom;

        if(typeSaisie.equals("modification")) {
            System.out.println("Ancien Prenom: " + Contrat.getPrenom() + "\n");
        }
    ...
    private int saisieAge(Contrat Contrat, String typeSaisie) throws InterruptedException {

        boolean ageInput;
        String age;

        if(typeSaisie.equals("modification")) {
            System.out.println("Ancien Age: " + Contrat.getAge() + "\n");
        }
    ...
    private String saisieEmail(Contrat Contrat, String typeSaisie) throws InterruptedException {

        boolean emailInput;
        String email;

        if(typeSaisie.equals("modification")) {
            System.out.println("Ancien Email: " + Contrat.getEmail() + "\n");
        }
    ...
    private int saisieTelephone(Contrat Contrat, String typeSaisie) throws InterruptedException {

        boolean telephoneInput;
        String telephone;

        if(typeSaisie.equals("modification")) {
            System.out.println("Ancien Telephone: " + Contrat.getTelephone() + "\n");
        }
        ...
        if(typeSaisie.equals("lecture")) {
            ...
            Contrat.setTelephone(intTelephone);
            System.out.println("Saisie complétè avec succès");
            return intTelephone;
        }
