...
public class Operationel extends Employe {

    // attributs

    private final String TYPE_EMPLOYE = "Operationel";
    ...
    Operationel(int id, String nom, String prenom, int age, String email, int telephone, String niveau, Contrat contrat) {
