...
public class Dirigeant extends Employe {

    // attributs

    private final String TYPE_EMPLOYE = "Dirigeant";
    ...
    Dirigeant(int id, String nom, String prenom, int age, String email, int telephone, String niveau, Contrat contrat) {
